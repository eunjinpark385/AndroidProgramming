...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Check Battery Status");

        ivBattery = (ImageView) findViewById(R.id.ivBattery);
        edBattery = (EditText) findViewById(R.id.edBattery);
    }
    ...
    BroadcastReceiver br = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                edBattery.setText("현재 충전량 : " + remain + " %\n");
                ...
                else if (remain >= 10) ivBattery.setImageResource(R.drawable.battery_0);

                int plug = intent.getIntExtra(BatteryManager.EXTRA_PLUGGED, 0);
                switch (plug) {
                    case 0:
                        edBattery.append("전원 연결 : 안됨");
                        break;
                    case BatteryManager.BATTERY_PLUGGED_AC:
                        edBattery.append("전원 연결 : 어댑터 연결됨");
                        break;
                    case BatteryManager.BATTERY_PLUGGED_USB:
                        edBattery.append("전원 연결 : USB 연결됨");
                        break;
                }
            }
        }
